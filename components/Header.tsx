...
function Header({ className }: Props) {
  ...
  return (
    <header className={`${className} flex items-center justify-between w-screen py-10 fixed left-0 top-0 px-40 font-medium z-30 ${isScrolled ? "border-b border-solid border-light/10 backdrop-blur-md" : ""}`}>
      <Link href="/">
