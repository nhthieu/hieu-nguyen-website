...
function SideBar({ }: Props) {
  return (
    <motion.div
      ...
      className='fixed left-0 top-[50%] -translate-y-1/2 h-[20%] px-1 bg-dark/75 dark:bg-light/10 backdrop-blur flex flex-col items-center justify-center space-y-2 lg:hidden'
    >
